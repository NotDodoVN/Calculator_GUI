...
#lambda expression so can pass a function and run the function only if they are called
...
btn_equal = tk.Button(root, text="=", command=evaluate_calculation, width=7, font=("Arial",14))
btn_equal.grid(row=6,column=2)

btn_clear = tk.Button(root, text="AC", command=clear_field, width=7, font=("Arial",14))
